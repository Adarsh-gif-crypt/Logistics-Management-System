...
conn=mysql.connector.connect(host='localhost',database='log',user='root',password='root123')
cursor=conn.cursor()
...
class add_book:
    def __init__(self,root):
        ...
        # self.n7=Label(text=':',fg="black",bg="dodgerblue3",font=('Calibri',14))
        # self.n8=Label(text='',fg="black",bg="dodgerblue3",font=('Calibri',14))

        self.b1=Button(text='ADD ORDER',fg='white',bg='dark red',width=20,height=2,command=lambda: self.buttonclick(0))
    ...
    def buttonclick(self,num):
        ...
        if(num==0):
            print(1)
            sql_insert_book = " insert into orders VALUES (%s,%s,%s)"
            print(2)
