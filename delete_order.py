...
class add_book:
    def __init__(self,root):
        ...
        self.b1=Button(text='DELETE Animal',fg='white',bg='dark red',width=20,height=2,command=lambda: self.buttonclick(0))
    ...
    def buttonclick(self,num):
        ...
        if(num==0):
            print(1)
            sql_delete_animal = "delete FROM order WHERE name=%s AND address=%s"
            print(2)
